...
export default {
  ...
  launchFailed: {
    ...
    hintDwproton11: 'Your installed DWProton build is missing kernel functions needed by Endfield, causing the game to abort. Open Proton settings to update to DWProton 11.0-13 or newer.',
    hintNtoskrnl: 'The game called a kernel function (PsGetProcessExitStatus) that this Proton version does not implement yet, and aborted. Open Proton settings to select DWProton 11.0-13 or newer.',
    ...
    hintXalia: 'Proton\u2019s bundled accessibility assistant (Xalia) failed to start because no supported video driver was found. Disabling Xalia via PROTON_USE_XALIA=0 resolves this issue.',
    hintPrefixCorrupted: 'The Wine prefix is corrupted or was downgraded from a newer Proton version (DWProton 11 to 10), which breaks font and system libraries. Open Diagnostics settings and click "Reset prefix" to regenerate a clean prefix.',
    openProtonSettings: 'Open Proton settings',
    openDiagnosticsSettings: 'Open Diagnostics settings',
  },
  logViewer: {
    copy: 'Copy log',
    copied: 'Log copied.',
